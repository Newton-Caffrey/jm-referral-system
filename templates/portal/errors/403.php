...
?>
<section class="jmrs-portal-section jmrs-portal-error" aria-labelledby="jmrs-portal-403-title">
	<h2 id="jmrs-portal-403-title" class="jmrs-portal-section__title"><?php echo esc_html__( 'Access denied', 'jm-referral-system' ); ?></h2>
