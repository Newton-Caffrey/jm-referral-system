<?php
/**
 * Email template: new referral created / assigned on create.
 *
 * @package JMReferral
 *
...
<head>
	<meta charset="UTF-8" />
	<title><?php echo esc_html__( 'New Referral', 'jm-referral-system' ); ?></title>
</head>
<body style="font-family: Arial, sans-serif; color: #1d2327; line-height: 1.5;">
	<p><?php echo esc_html__( 'A new referral has been created and assigned to you.', 'jm-referral-system' ); ?></p>
